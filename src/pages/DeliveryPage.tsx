...
export default function DeliveryPage() {
  ...
  const stats = [
    { title: "Today Orders", value: 10, color: "blue" },
    { title: "All Orders", value: 10, color: "red" },
    { title: "Success Orders", value: 10, color: "green" },
    { title: "Total Coin", value: 1000, color: "purple" },
  ];
    ...
    <div className="flex justify-center items-center flex-col">
      <div className="md:w-96 w-full p-3">
        ...
        <div className="bg-[#A8BBA3] text-white text-xs px-2 py-1 my-3">
          <p className="text-sm font-bold mt-1">Orders in Meanchey District</p>
        </div>
          ...
          {ordersUser?.map((item, i) => (
            <div key={i} className="flex p-2 border-2">
              ...
              <div className="w-40">
                ...
                <p className="text-xs font-bold">
                  Information :{" "}
                  <span className="font-normal">{item.shipping_address} </span>{" "}
                </p>
                <p className="text-xs font-bold">
                  Items :{" "}
                  <span className="font-normal">{item.order_items.length}</span>{" "}
                </p>
                <p className="text-xs font-bold">
                  Total :{" "}
                    ...
                    <select
                      ...
                      onChange={async (e) => {
                        ...
                        if (newStatus === "Completed") {
                          ...
                          toast.success("Seller's wallet updated successfully");
                        }
